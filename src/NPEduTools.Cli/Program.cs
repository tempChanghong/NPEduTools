...
if (args[0] is not ("ping" or "status" or "schedule" or "watch" or "stop") ||
...
string capability = args[0] switch { "ping" => "host.ping", "stop" => "host.stop", "watch" => "classisland.watch", "schedule" => "classisland.schedule", _ => "classisland.status" };
